    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-2xl p-6">
        <div className="flex items-start space-x-3">
          <ClipboardDocumentListIcon className="w-6 h-6 text-blue-600 mt-1" />
          <div className="space-y-2">
            <h3 className="font-semibold text-blue-900">Proje Yönetimi - Supabase Gerekli</h3>
            <p className="text-sm text-blue-800">
              Proje yönetimi için Supabase database bağlantısı gereklidir. 
      ...
      <div className="bg-white p-12 rounded-2xl shadow-sm border border-gray-100 text-center">
        ...
        <p className="text-gray-600">
          Proje yönetimi için Supabase database bağlantısı kurulmalıdır.
        </p>
      </div>
    </div>
  );
